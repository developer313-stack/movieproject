...
export default function Fantasy() {
  ...
  useEffect(() => {
    fetch(`https://api.themoviedb.org/3/discover/movie?api_key=70529d61fe54b1ad1ecaac7877cf57d4&with_genres=14&page=${page}&language=tr-Turkish`)
  ...
  return (
    <div className='prevs'>
      <Navbar/>
      <h4 className='all-movies'>Fantastik</h4>
      <div className='arrow'>
      <h5 onClick={() => {
          if (page === 1) {
