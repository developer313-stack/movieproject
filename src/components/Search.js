    ...
    return (
        <div>
            <div className='search-content'>
               ...
               <Link to="/home"><FontAwesomeIcon className='ikon' icon={faArrowLeft} /></Link> <input type="text" id="input" className="search-input" onChange={(e)=>{setFilm(e.target.value)}} placeholder='Film axtar...'></input>
                </div>
